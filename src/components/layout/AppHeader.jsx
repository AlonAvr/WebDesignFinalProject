...
export function AppHeader() {
  return (
    <header className="flex h-[4.25rem] shrink-0 items-center justify-between border-b border-border/80 bg-background/95 px-6 backdrop-blur-sm lg:px-8">
      <div className="relative w-full max-w-sm">
        <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
        <Input
          placeholder="Search costs, categories..."
          aria-label="Search costs and categories"
          className="h-10 border-transparent bg-muted/70 pl-9 shadow-none placeholder:text-muted-foreground/80 focus-visible:border-ring"
          disabled
        />
      </div>
